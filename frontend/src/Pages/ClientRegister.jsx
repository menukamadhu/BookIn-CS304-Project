  ...
  return (
    <div>
        ...
        <section name='Welcome' className=''>
            <div className="relative flex-col w-2/3 h-screen hero ">
                <img src={Client} alt="" className='hidden object-fill w-full h-full md:block' />
            ...
            <div className="absolute left-20 bottom-32">
                ...
                <p className="mb-5 text-2xl text-white">The Smartest Salon Scheduling Software of its kind.</p>
                    ...
                    <div className="absolute grid grid-flow-col gap-8 bottom-10">
        ...
        <section name='Register'>
            <div className='absolute top-0 flex flex-col justify-between w-full h-full p-20 bg-white md:py-32 md:w-1/3 md:left-2/3'>   
                <div className='flex flex-col'>
                    <h2 class="text-5xl font-bold text-blue-800">Register for Client</h2>
                </div>
                <div className='flex flex-col items-center justify-center'>
                    <form action="" class="flex flex-col gap-4 w-full">
                    <input class="p-2  border-2 bg-white border-gray-300" type="text" name="businessname" placeholder="First Name" required/>
                    <input class="p-2  border-2 bg-white border-gray-300" type="text" name="businessname" placeholder="Last Name" required/>
                    <input class="p-2  border-2 bg-white border-gray-300" type="email" name="email" placeholder="E-mail" />
                    <div className='flex flex-row justify-between pl-3'>
                        <label htmlFor="" className='justify-between text-gray-400'>Gender</label>
                        <div className='flex flex-row'>
                            <input type="radio" name="radio-5" className="radio radio-success" checked />
                            <p className='pl-4 text-gray-400'>Male</p>
                        </div>
                        <div className='flex flex-row pr-3'>
                            <input type="radio" name="radio-5" className="bg-white radio radio-success" />
                            <p className='pl-4 text-gray-400'>Female</p>
                        </div>
                    </div>
                    <input class="p-2  border-2 bg-white border-gray-300" type="text" name="contactnum" placeholder="Contact Number" required/>
                    <input class="p-2  border-2 bg-white border-gray-300" type="password" name="password" placeholder="Password"required/>
                    <div class="relative">
                        <input class="w-full p-2 border-2 bg-white border-gray-300" type="password" name="password" placeholder="Confirm Password" /> 
                ...
                <div className='pt-8'>
                        <button className="px-8 bg-green-500 btn btn-accent hover:bg-green-600" onClick={()=>setShowModal(true)}>Register</button>
                    </div>
                </div>
        ...
        <SuccessfulModal visible={ShowModal}/>
      </div>
    </div>
  )
}
